	...
	t.Run("returns signal data", func(t *testing.T) {
		...
		expected := SignalData{
			1: SignalDatum{
				...
				IFrequency:     651000000,
				ISNRatio:       31,
				IPowerLevel:    7,
				ICorrectable:   2895843,
				IUncorrectable: 340003,
			},
			2: SignalDatum{
				Frequency:      "657000000",
				SNRatio:        "31",
				...
				IFrequency:     657000000,
				ISNRatio:       31,
				IPowerLevel:    8,
				ICorrectable:   3946112,
				IUncorrectable: 232351,
			},
			3: SignalDatum{
				Frequency:      "723000000",
				SNRatio:        "29",
				...
				IFrequency:     723000000,
				ISNRatio:       29,
				IPowerLevel:    7,
				ICorrectable:   53513438,
				IUncorrectable: 417213,
			},
		}
